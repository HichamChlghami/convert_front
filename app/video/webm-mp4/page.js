...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>Webm to MP4 Converter</h1>
      <p className='description'>Convert From Webm To MP4 Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your Webm here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from Webm to MP4 ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your Webm files with the 'Choose Webm' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to MP4</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download MP4' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your Webm files and tap 'Convert'. Our tool guarantees the highest quality MP4 conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of Webm images to MP4 with our tool, which also accommodates animated Webm files.  </p>
</div>

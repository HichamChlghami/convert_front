...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>MOV to MP4 Converter</h1>
      <p className='description'>Convert From MOV To MP4 Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your MOV here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from MOV to MP4 ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your MOV files with the 'Choose MOV' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your MOV files and tap 'Convert'. Our tool guarantees the highest quality MP4 conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of MOV images to MP4 with our tool, which also accommodates animated MOV files.  </p>
</div>

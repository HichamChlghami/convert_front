...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Convert From Video To Audio Online Free, Fast, Secure and in few clicks</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from Video to Audio ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your Video files with the 'Choose Video' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to Audio</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download Audio' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your Video files and tap 'Convert'. Our tool guarantees the highest quality Audio conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of Video images to Audio with our tool, which also accommodates animated Video files.  </p>
</div>

...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>MP4 to MP3 Converter</h1>
      <p className='description'>Convert From MP4 To MP3 Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your MP4 here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from MP4 to MP3 ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your MP4 files with the 'Choose MP4' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your MP4 files and tap 'Convert'. Our tool guarantees the highest quality MP3 conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of MP4 images to MP3 with our tool, which also accommodates animated MP4 files.  </p>
</div>

...
const handleFileUpload = async (e) => {
 ...
 await axios.post(`${apiUrl}/CompressImages`, formData, {
          headers: {
  ...
  useEffect(() => {
    ...
    const checkConversionProgress = async () => {
      try {
        ...
        const responseCompressImages = await axios.get(`${apiUrl}/progressCompressImages`);
        const progress0 = responseCompressImages.data.progress;
...
<title>Advanced Image Optimization Service: Enhancing Quality and User Experience</title>

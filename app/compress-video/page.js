...
const handleFileUpload = async (e) => {
 ...
 await axios.post(`${apiUrl}/compressVideo`, formData, {
          headers: {
  ...
  useEffect(() => {
    ...
    const checkConversionProgress = async () => {
      try {
        ...
        const responseCompressVideo = await axios.get(`${apiUrl}/progressCompressVideo`);
        const progress0 = responseCompressVideo.data.progress;
...
<div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Optimize videos with the best compression tool.</p>
...
<title>Advanced Video Compression Service: Maximizing Quality and Efficiency</title>
        <meta name="description" content="Discover professional video compression Service to optimize quality and efficiency. Learn about the latest advancements in video compression technology and how to apply them effectively. Improve search engine visibility and enhance user experience with expert compression strategies." />

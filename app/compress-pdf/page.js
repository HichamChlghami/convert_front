...
const handleFileUpload = async (e) => {
 ...
 await axios.post(`${apiUrl}/CompressPdf`, formData, {
          headers: {
  ...
  useEffect(() => {
    ...
    const checkConversionProgress = async () => {
      try {
        ...
        const responseCompressPdf = await axios.get(`${apiUrl}/progressCompressPdf`);
        const progress0 = responseCompressPdf.data.progress;
...
<div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Optimize PDF with the best compression tool.</p>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Enjoy the benefits of a free, secure, and universally compatible tool accessible from any web browser. For added security and privacy, pdf are automatically deleted after a few hours.
  </p>
</div>
...
<title>Professional PDF Compression Service: Reduce File Size Without Sacrificing Quality</title>
<meta name="description" content="Unlock the full potential of your PDF documents with our professional compression service. We specialize in reducing file sizes while maintaining exceptional quality. Discover how our advanced compression techniques can optimize your PDFs for faster sharing, improved storage efficiency, and enhanced user experience." />

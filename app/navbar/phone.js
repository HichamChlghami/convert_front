...
<div className="image_container_phone">
    <img src='/sitfile_logo1.svg' alt='logo' className='navbar_image_phone'/>
  </div>
...
<div className="convert_container_phone">
     ...
     <FaAngleDown className='convert_ico_phone'/>
      ...
      </div>
      {
        ...
        <Link href='https://webhived.com/about-us.html' className='phone_url '>Image Converter</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url '>Document Converter</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url '>PDF Converter</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url '>Video Converter</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url '>Audio Converter</Link>
    ...
    <div className="convert_container_phone">
     ...
     <FaAngleDown className='convert_ico_phone'/>
      ...
      </div>
      {
        showCompress1 && (
          <ul className='convert_container-links_phone'>
        <Link href='https://webhived.com/about-us.html' className='phone_url'>Image Compressor</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url'>PDF Compressor</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url'>Video Compressor</Link>
        <Link href='https://webhived.com/about-us.html' className='phone_url'>Audio Compressor</Link>

...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>JPG to Excel Converter</h1>
      <p className='description'>Convert From JPG To Excel Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your JPG here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from JPG to Excel ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your JPG files with the 'Choose JPG' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to Excel</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download Excel' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your JPG files and tap 'Convert'. Our tool guarantees the highest quality Excel conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of JPG images to Excel with our tool, which also accommodates animated JPG files.  </p>
</div>
...
<title>JPG to Excel Converter</title>
  <meta name="description" content="Convert From JPG To Excel Online Free, Fast, Secure and in few clicks" />

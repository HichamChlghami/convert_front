...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>SVG to ICO Converter</h1>
      <p className='description'>Convert From SVG To ICO Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your SVG here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from SVG to ICO ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your SVG files with the 'Choose SVG' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to ICO</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download ICO' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your SVG files and tap 'Convert'. Our tool guarantees the highest quality ICO conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of SVG images to ICO with our tool, which also accommodates animated SVG files.  </p>
</div>
...
<title>SVG to ICO Converter</title>
  <meta name="description" content="Convert From SVG To ICO Online Free, Fast, Secure and in few clicks" />

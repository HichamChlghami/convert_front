...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>PNG to SVG Converter</h1>
      <p className='description'>Convert From PNG To SVG Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your PNG here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from PNG to SVG ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your PNG files with the 'Choose PNG' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your PNG files and tap 'Convert'. Our tool guarantees the highest quality SVG conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of PNG images to SVG with our tool, which also accommodates animated PNG files.  </p>
</div>
...
<title>PNG to SVG Converter</title>
  <meta name="description" content="Convert From PNG To SVG Online Free, Fast, Secure and in few clicks" />

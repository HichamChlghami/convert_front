...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>WebP to JPG Converter</h1>
      <p className='description'>Convert From WebP To JPG Online Free, Fast, Secure and in few clicks</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from WebP to JPG ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your WebP files with the 'Choose WebP' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to JPG</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download JPG' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your WebP files and tap 'Convert'. Our tool guarantees the highest quality JPG conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of WebP images to JPG with our tool, which also accommodates animated WebP files.  </p>
</div>

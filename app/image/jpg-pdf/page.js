...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>JPG to PDF Converter</h1>
      <p className='description'>Convert From JPG To PDF Online Free, Fast, Secure and in few clicks</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from JPG to PDF ?</h2>
    </div>
...
<div className='how_work_card'>
  ...
  Just upload your JPG files and tap 'Convert'. Our tool guarantees the highest quality PDF conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of JPG images to PDF with our tool, which also accommodates animated JPG files.  </p>
</div>

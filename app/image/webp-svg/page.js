...
function App() {
  ...
  const validFormats = {
  validImages :['png', 'jpeg', 'svg', 'ico', 'gif', 'psd', 'webp', 'bmp', 'WebP', 'tiff', 'jpeg', 'tga', 'ico', 'eps'],
  validSVG : ['SVG'],
  ...
  validVidoAudio : [
    ...
    validDevives :['WebP', 'mobile', 'kindle', 'ipad', 'android', 'psp', 'iphone'],
  // these will use for just for chose the right library
  image_svg:['png', 'jpeg',  'ico', 'gif', 'psd', 'webp' ,'bmp', 'WebP', 'tiff', 'jpeg', 'tga', 'ico', 'eps','SVG'],
  svg:['svg'],
  ...
  MergeExcel:['csv' , 'xml' , 'SVG','rtf','odt','png', 'jpeg',],
  MergeMicro:[ 'SVG','rtf','odt','png', 'jpeg',],
...
const handleFileUpload = async (e) => {
  try {
    ...
    await Promise.all(files.map(async (file, index) => {
      ...
      } else if (validFormats.validSVG.includes(fileExtension)) {
...
files.forEach((file) => {
  ...
  if (validFormats.validImages.includes(fileExtension)) {
    ...
    fileAvailableFormats = [{
      ...
      Image: ['PNG', 'JPEG', 'SVG', 'ICO', 'GIF', 'PSD', 'WEBP', 'BMP', 'WebP', 'TIFF', 'JPEG', 'TGA', 'ICO', 'EPS'],
      Document: ['TXT', 'TEXT', 'SVG', 'WORD', 'DOC', 'DOCX', 'HTML', 'EXCEL','PPT', 'PPTX', 'XLSX', 'XLS'],
    ...
    fileAvailableFormats = [{
      ...
      Document: ['TXT', 'TEXT', 'PS', 'SVG', 'WORD', 'DOC', 'DOCX', 'EXCEL', 'XLSX', 'XLS', 'ODT', 'PPT', 'PPTX', 'RTF', 'EPUB', 'AZW3', 'MOBI', 'HTML'],
      Image: ['PNG', 'JPEG', 'SVG', 'ICO', 'GIF', 'PSD', 'WEBP', 'BMP', 'WebP', 'TIFF', 'TGA', 'ICO', 'EPS'],
      Ebook :['EPUB' , 'AZW3' , 'MOBI']
...
{   
  category:[{la:"Image"},{la:"Document"},],
  Document: ['CSV', 'XML', 'SVG', 'ODT', 'RTF', 'TEXT', 'TXT'],
  Image: ['PNG', 'JPEG','GIF',],
  ...
  fileAvailableFormats = [
    {   
      ...
      Document: ['SVG', 'TXT', 'DOCX', 'DOC', 'WORD', 'XLSX', 'XLS', 'EXCEL', 'HTML', 'PPT', 'PPTX'],
      Image: ['PNG', 'JPEG','GIF',],
  ...
  fileAvailableFormats = [
    ...
    {   
      category:[{la:"Image"},{la:"Document"},],
      Document: ['SVG', 'TXT', 'TEXT', 'DOCX', 'DOC', 'WORD', 'XLSX', 'XLS', 'EXCEL', 'HTML', 'PPT', 'PPTX'],
      Image: ['PNG', 'JPEG', 'SVG', 'ICO', 'GIF', 'PSD', 'WEBP', 'BMP', 'WebP', 'TIFF', 'TGA', 'ICO', 'EPS'],
...
Image:['GIF'],
      // Device:['WebP', 'mobile', 'kindle', 'ipad', 'Android', 'PSP', 'iphone'],
...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>WebP to SVG Converter</h1>
      <p className='description'>Convert From WebP To SVG Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your WebP here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from WebP to SVG ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your WebP files with the 'Choose WebP' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to SVG</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download SVG' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your WebP files and tap 'Convert'. Our tool guarantees the highest quality SVG conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of WebP images to SVG with our tool, which also accommodates animated WebP files.  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Enjoy the benefits of a free, secure, and universally compatible tool accessible from any web browser. For added security and privacy, files are automatically deleted after a few hours  </p>
</div>
...
<title>WebP to SVG Converter</title>
  <meta name="description" content="Convert From WebP To SVG Online Free, Fast, Secure and in few clicks" />

...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Convert From PDF To Word Online Free, Fast, Secure and in few clicks</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from PDF to Word ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your PDF files with the 'Choose PDF' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to Word</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download Word' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your PDF files and tap 'Convert'. Our tool guarantees the highest quality Word conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of PDF images to Word with our tool, which also accommodates animated PDF files.  </p>
</div>
...
<title>PDF to Word Converter</title>
  ...
  <link rel="canonical" href="https://www.sitfile.com/image/pdf-word" />

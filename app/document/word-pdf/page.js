...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Convert From Word To PDF Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your Word here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from Word to PDF ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your Word files with the 'Choose Word' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your Word files and tap 'Convert'. Our tool guarantees the highest quality PDF conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of Word images to PDF with our tool, which also accommodates animated Word files.  </p>
</div>
...
<title>Word to PDF Converter</title>
  ...
  <link rel="canonical" href="https://www.sitfile.com/image/Word-pdf" />

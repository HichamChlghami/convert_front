...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>PDF to Excel Converter</h1>
      <p className='description'>Convert From PDF To Excel Online Free, Fast, Secure and in few clicks</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from PDF to Excel ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your PDF files with the 'Choose PDF' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your PDF files and tap 'Convert'. Our tool guarantees the highest quality Excel conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of PDF images to Excel with our tool, which also accommodates animated PDF files.  </p>
</div>
...
<title>PDF to Excel Converter</title>
  ...
  <link rel="canonical" href="https://www.sitfile.com/image/pdf-excel" />

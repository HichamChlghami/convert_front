...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <p className='description'>Convert From Excel To PDF Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your Excel here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from Excel to PDF ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your Excel files with the 'Choose Excel' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your Excel files and tap 'Convert'. Our tool guarantees the highest quality PDF conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of Excel images to PDF with our tool, which also accommodates animated Excel files.  </p>
</div>
...
<title>Excel to PDF Converter</title>
  ...
  <link rel="canonical" href="https://www.sitfile.com/image/excel-pdf" />

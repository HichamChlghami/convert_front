...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>EPUB to PDF Converter</h1>
      <p className='description'>Convert From EPUB To PDF Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your EPUB here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from EPUB to PDF ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your EPUB files with the 'Choose EPUB' button</p>
  <p className='description_p'>2.Initiate the conversion process by clicking 'Convert to PDF</p>
  <p className='description_p'>3.Once the status reads 'Done', hit 'Download PDF' to retrieve your converted files</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your EPUB files and tap 'Convert'. Our tool guarantees the highest quality PDF conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of EPUB images to PDF with our tool, which also accommodates animated EPUB files.  </p>
</div>
...
<title>EPUB to PDF Converter</title>
  ...
  <link rel="canonical" href="https://www.sitfile.com/image/epub-pdf" />

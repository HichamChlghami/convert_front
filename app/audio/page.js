...
<div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>Sit an Audio and Let us convert it</h1>
      <p className='description'>Seamlessly switch Audio formats with our online converter.</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert an Audio ?</h2>
    </div>
  <p className='description_p'>1.Convert your Audios easily by starting with selecting them using the 'Choose Audios' button</p>
  <p className='description_p'>2.Initiate the conversion process by choosing the desired format and clicking convert to</p>
  <p className='description_p'>3.Once the conversion is complete, click 'Download' to retrieve your converted Audios</p>
</div>
...
<div className='how_work_card'>
  ...
  Just upload your Audios and tap 'Convert'. Our tool guarantees the highest quality conversion. Unbeatable Features
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches Audios with our tool, which accommodates any Audio formats.
  </p>
</div>
...
<title>Audio Converter Tool: Effortless Format Conversion & Optimization</title>
  <meta name="description" content="Discover the ultimate solution for converting Audios with our versatile Image Converter Tool. Easily switch between formats like JPEG, PNG, GIF, and more to suit your needs. Streamline your workflow by resizing, compressing, or optimizing images for maximum efficiency. With our user-friendly interface, you can transform your visuals in seconds, ensuring compatibility across platforms. Say goodbye to format headaches and hello to seamless image conversion with our powerful tool." />

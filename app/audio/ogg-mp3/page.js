...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>OGG to MP3 Converter</h1>
      <p className='description'>Convert From OGG To MP3 Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your OGG here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from OGG to MP3 ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your OGG files with the 'Choose OGG' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your OGG files and tap 'Convert'. Our tool guarantees the highest quality MP3 conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of OGG images to MP3 with our tool, which also OGGommodates animated OGG files.  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Enjoy the benefits of a free, secure, and universally compatible tool OGGessible from any web browser. For added security and privacy, files are automatically deleted after a few hours  </p>
</div>
...
<title>OGG to MP3 Converter</title>

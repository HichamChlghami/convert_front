...
const handleOpenNewTab = () => {
  ...
  return (
   ...
   <div className="convert" onDrop={handleDrop}onDragOver={handleDragOver}>
      ...
      <h1 className='title'>ACC to MP3 Converter</h1>
      <p className='description'>Convert From ACC To MP3 Online Free, Fast, Secure and in few clicks</p>
...
<p className='update'>"      <BsFillLockFill style={{color:"#2ecc71"}} /> Drop your ACC here"</p>
...
<div className='describe_how_convert'>
  <div className='full_how_convert'>
    ...
    <h2 className='how_convert'>How to convert from ACC to MP3 ?</h2>
    </div>
  <p className='description_p'>1.Begin by selecting your ACC files with the 'Choose ACC' button</p>
...
<div className='how_work_card'>
  ...
  Just upload your ACC files and tap 'Convert'. Our tool guarantees the highest quality MP3 conversion
  </p>
</div>
...
<div className='how_work_card'>
  ...
  <p className='how_work_description'>
  Effortlessly convert batches of ACC images to MP3 with our tool, which also accommodates animated ACC files.  </p>
</div>
...
<title>ACC to MP3 Converter</title>
  <meta name="description" content="Convert From ACC To MP3 Online Free, Fast, Secure and in few clicks" />
